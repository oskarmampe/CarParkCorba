...
'''
Main Entry Point for the exit gate application.
...
def main(argv):
    ...
    try:
        ...
        eg = ExitGate(sys.argv, local_server)
        eo = eg._this()
        ...
        initial_machine_name = raw_input("\nType the initial device "
                                         "name of the exit gate.\n")
        # bind the Count object in the Naming service
        exit_gate_name = [CosNaming.NameComponent(initial_machine_name, "")]
        rootContext.rebind(exit_gate_name, eo)
